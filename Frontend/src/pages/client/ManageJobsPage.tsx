...
const JOBS_INIT: Job[] = [
  {
    ...
    applicants: [
      ...
      },
      {
        ...
        appliedAt: "1 day ago",
        status: "pending",
        bio: "Frontend developer with strong design sense. Loves building pixel-perfect interfaces.",
        github: "github.com/roshanbhandari",
      },
      {
        id: "a3",
        name: "Sita Adhikari",
        ...
        status: "pending",
        bio: "Graphic design student eager to take on real-world projects and grow professionally.",
      },
    ],
  },
  {
    ...
    postedAt: "4 days ago",
    description:
      "Build a personal portfolio website using React and TailwindCSS based on a provided Figma design. Must be deployed to Vercel and fully responsive across all devices.",
    requirements:
    ...
    applicants: [
      {
        ...
        status: "pending",
        bio: "Full-stack developer specialising in React and Node.js. Focused on clean, maintainable code.",
        github: "github.com/bikashrai",
        linkedin: "linkedin.com/in/bikashrai",
      },
      {
        id: "a5",
        name: "Ramit Sonar",
        ...
        appliedAt: "3 days ago",
        status: "pending",
        bio: "Computer Engineering student passionate about modern web development and open source.",
    ...
    applicants: [
      {
        ...
        skills: [
          { name: "Canva", verified: false },
          { name: "PowerPoint", verified: false },
        ],
        rating: 4.3,
        reviewCount: 3,
        completedProjects: 1,
        ...
        status: "pending",
        bio: "Mass communication student with a strong eye for visual storytelling and presentation design.",
      },
    ],
  },
  {
